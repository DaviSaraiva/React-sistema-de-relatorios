...
const DatatablePage = () => {
  ...
  useEffect(() => {
    axios.get('http://139.162.233.71:8081/finaceiroCartao2').then(response => {
  ...
  const filtro=(evento)=>{
    ...
    axios.post('http://139.162.233.71:8081/finaceiroCartao2',{'inicial':inicial,'final':final}).then(response => {
        setInformacoes(response.data)
    });
  }
